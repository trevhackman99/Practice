...
for s in sets:
    ...
    formattedData = []
    formattedJSON = f"formattedData{s}.json"
    ...
    with open(f'dataCombined{s}.json', 'r') as f:
        data = json.load(f)
        allKeys = data[0].keys()
    ...
    for card in data:
        ...
        for key in desiredKeys:
            ...
            if key == "set":
                ...
                elif formattedCard['normal'] == None or formattedCard['normal'] < .10:
                    formattedCard["normal"] = .10
